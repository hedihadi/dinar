...
class PlayerComesOnline_PlayerWidget extends StatefulWidget {
  PlayerComesOnline_PlayerWidget({Key? key, required this.player}) : super(key: key);
  Player player;
  @override
  State<PlayerComesOnline_PlayerWidget> createState() => _MyServerState();
}

class _MyServerState extends State<PlayerComesOnline_PlayerWidget> {
  @override
  void dispose() {
    super.dispose();
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                ...
                Flexible(
                  child: Align(
                    ...
                    child: IconButton(
                        ...
                        icon: widget.player.favorited == false ? Icon(Icons.bookmark_add) : Icon(Icons.bookmark_remove),
            ...
            ElevatedButton(
              onPressed: () {
                context.read<AddNewNotificationProvider>().set_player(widget.player);
              },
              child: Text(
                "Select",
